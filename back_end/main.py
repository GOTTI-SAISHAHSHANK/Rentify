...
app.include_router(appliances_router, prefix="/api/appliances", tags=["Appliances"])
app.include_router(electronics_router, prefix="/api/electronics", tags=["Electronics"])
app.include_router(furniture_router, prefix="/api/furniture", tags=["Furniture"])
app.include_router(baby_and_kids_router, prefix="/api/baby_and_kids", tags=["Baby and Kids"])
app.include_router(package_router, prefix="/api/package", tags=["Package"])
app.include_router(real_estate_router, prefix="/api/real_estate", tags=["Real Estate"])
...
origins = [
    ...
    "https://rentify-ms7zdvzsh-gotti-saishahshanks-projects.vercel.app"
]
